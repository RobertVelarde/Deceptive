...
// revealed their role (roleRevealed=true). Also shows a speaking order card.
import React from 'react';
import { GlassCard }          from '../../../components/shared/GlassCard';
import { WordGrid }           from '../../../components/shared/WordGrid';
import { SpeakingOrderCard }  from '../../../components/shared/SpeakingOrderCard';
  ...
  return (
    <>
      <GlassCard className="p-4 flex flex-col gap-2">
        {assignment.category && (
          <p className="text-xs uppercase tracking-widest text-zinc-400 text-center">
            {assignment.category}
          </p>
        )}
        <WordGrid
      ...
      <SpeakingOrderCard
        ...
        seed={state.seed}
        myId={assignment.playerId}
        accentColor={module.constants.COLORS?.primary}
      />
    </>
  );
}
