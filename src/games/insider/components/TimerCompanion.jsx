...
// Answer-tally panel rendered beside the round timer during an Insider round.
// The Master answers every question with Yes, No, or "I don't know" —
// players use this to keep count without losing track.
//
// Requires state.answerTracking === true to render.
// When state.answerLimit is true, the + buttons for Yes and No are disabled
// once yes+no totals reach state.answerLimitCount.
...
export function InsiderTimerCompanion({ state }) {
